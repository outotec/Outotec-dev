    ...
    <Layout>
      ...
      <Positions>
        <Position title={'Lead Cloud Developer, Espoo'}>
          <p>
            We are looking for new lead developer to join our customer portal development team. The cloud-based portal will offer asset analytics, digital twins or virtual training environments, and access to information such as documents, spare part catalogs and service requests to our customers. 
          </p>
          <p>
            The customer portal is developed as part of Outotec’s Digital Solutions Platform – a team of over thirty software professionals focused on solving real-world challenges to improve safety, performance and sustainability of our customers’ operations. We use a multitude of technologies such as machine vision, physics and chemistry-based simulation, advanced process control and optimization, IoT and connectivity, analytics and machine learning, and a web portal to enable development and delivery of Outotec’s digital services.
          </p>
          <p><strong>What awaits you</strong></p>
          <ul>
            <li>Lead role in architecture design and technology decisions regarding the customer portal</li>
            <li>Close collaboration with the product owner and the multiple stakeholders</li>
            <li>Demanding software development tasks in the frontend, backend, API’s, access management, component libraries, etc.</li>
          ...
          <ul>
            ...
            <li>A global environment in a company that provides leading technologies and services for the sustainable use of Earth’s natural resources</li>
            ...
            <li>Opportunities and time to learn, grow and develop yourself with training, courses, seminars, books and real project work</li>
          ...
          <ul>
            ...
            <li>Skills and willingness to express your own opinions and to justify them, for supporting decision making and developing the ways we work as a team</li>
